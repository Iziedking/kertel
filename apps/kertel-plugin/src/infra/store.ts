 ...
 *   not a kill switch;
 * - **payment attempts**, because an unresolved payment is money Kertel cannot
...
import { utcDay } from "@kertel/core/domain";
import type { Instant, SafetyState } from "@kertel/core/domain";
  ...
  return {
    ...
    safetyState(): SafetyState {
      ...
      return {
        ...
        // Real, not empty. An order Kertel submitted and never resolved is open
