/**
 * `kertel_status` — the capability truth table, rendered.
 *
...
export function statusTool(runtime: Runtime): AgentTool {
  return {
    ...
    label: "Kertel status",
    description:
      "Report what Kertel can and cannot currently do: mode, owner, research wallet and payment rails, " +
      "spend against the daily cap, the kill switch, and any unresolved payments. Reads local state only. " +
      "Use this before claiming any Kertel capability is available.",
