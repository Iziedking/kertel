...
export type AgentTool = {
  ...
  /**
   * Real sender restriction from the host, on top of Telt's own owner check.
   *
   * Defence in depth: the host allowlist is a routing convenience and Telt
...
export type RegisterOptions = {
   ...
   * `agents.list[].tools.allow`. Everything Telt registers that spends money
